...
Open and record a new claim on the correct client/policy.

## Screen path

Use this exact action path:

Action → Internal → Claims → New
...
- Claim/reference number if already assigned
- Adjuster or carrier contact if known
...
### 3. Choose Internal → Claims

In the Action menu, select **Internal**, then **Claims**. (Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)
...
### 5. Enter the loss and policy details

(Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 6. Record adjuster / carrier contact information
