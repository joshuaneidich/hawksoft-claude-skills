...
Attach or record proof-of-claim documentation on an existing claim.

## Screen path

Use this exact action path:

Action → Internal → Claims → (select claim)
...
- The existing claim
- The proof/documentation to attach
...
### 5. Attach or record the proof-of-claim documentation
