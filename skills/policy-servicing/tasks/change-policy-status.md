...
Change the status of a policy (for statuses beyond the endorse/cancel/renew/reinstate shortcuts).

## Screen path

Use this exact action path:

Action → Internal → Change Policy Status
...
### 4. Choose the new status and effective date
