...
Record a mid-term change (endorsement) on an existing policy.

## Screen path

Use this exact action path:

Select the policy → Endorse (one-click policy change)
...
### 3. Choose the Endorse one-click action

(Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 4. Enter the endorsement details and effective date
