...
Add a new policy to the correct client record.

## Screen path

Use this exact action path:

Action → Internal → Insert Policy
...
### 3. Choose Internal → Insert Policy

In the Action menu, select **Internal**, then **Insert Policy**. (Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 4. Choose line of business and carrier
...
### 5. Enter policy number, term dates, and premium
