...
Record a policy cancellation.

## Screen path

Use this exact action path:

Select the policy → Cancel (one-click policy change)
...
### 3. Choose the Cancel one-click action

(Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 4. Enter the cancellation reason and effective date
...
- The correct client or policy cannot be verified.
- The cancellation reason or effective date is missing.
