...
Duplicate a policy or set it up to remarket to another carrier.

## Screen path

Use this exact action path:

Action → Internal → Duplicate/Remarket Policy
...
- The source policy
- Whether duplicating or remarketing
- Target carrier if remarketing
...
### 4. Choose duplicate or remarket and set the target
