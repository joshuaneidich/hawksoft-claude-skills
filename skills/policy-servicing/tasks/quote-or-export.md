...
Start a quote or export policy data to a rater / carrier.

## Screen path

Use this exact action path:

Action → Internal → Quote/Export
...
- The policy or line of business
- The rater or export target
...
### 3. Choose the policy and the quote/export target
...
### 4. Confirm the data to send and start the quote/export
