...
Create a new client based on an existing one.

## Screen path

Use this exact action path:

Action → Internal → Duplicate Client

## Required information

Before beginning, obtain:

- The source client record
- What should carry over to the new record
...
### 3. Choose Internal → Duplicate Client

In the Action menu, select **Internal**, then **Duplicate Client**. (Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 4. Confirm what carries over and create the new record
