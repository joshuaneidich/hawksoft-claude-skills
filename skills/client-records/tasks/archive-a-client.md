...
Archive an inactive client record.

## Screen path

Use this exact action path:

Action → Internal → Archive Client
...
### 3. Choose Internal → Archive Client

In the Action menu, select **Internal**, then **Archive Client**. (Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 4. Confirm the archive and reason
