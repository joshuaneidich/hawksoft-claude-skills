...
Update contact or profile information on a client record.

## Screen path

Use this exact action path:

Action → Internal → Change Client
...
### 3. Choose Internal → Change Client

In the Action menu, select **Internal**, then **Change Client**. (Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 4. Edit the changed fields
