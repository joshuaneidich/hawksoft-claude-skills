...
Compose and send an email to the client or another party from HawkSoft, logged to the record.

## Screen path

Use this exact action path:

Action → Internal → Send Email
...
### 3. Choose the recipient and start the email
...
### 4. Enter subject, body, and attachments
