...
Document a text message exchange with an insured in the correct client record.

## Screen path

Use this exact action path:

Action → Text → Insured → Log
...
- **Yes, and this is a plain log** → log it there. In **New Log**, this task's path
  becomes **Channel** = Text, **Entity** = Insured, **From/To** = From for a text the
  agency received, To for one the agency sent. Follow `../references/web-logging.md`
...
### 4. Enter the message summary and any follow-up
