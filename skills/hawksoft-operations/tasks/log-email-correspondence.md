...
Document an email exchange with an insured in the correct client record.

## Screen path

Use this exact action path:

Action → Email → Insured → Log
...
- **Yes, and this is a plain log** → log it there. In **New Log**, this task's path
  becomes **Channel** = Email, **Entity** = Insured, **From/To** = From for email the
  agency received, To for email the agency sent. Follow `../references/web-logging.md`
...
### 4. Enter the email summary and any follow-up
