...
Document a fax sent or received for an insured in the correct client record.

## Screen path

Use this exact action path:

Action → Fax → Insured → Log
...
- **Yes, and this is a plain log** → log it there. In **New Log**, this task's path
  becomes **Channel** = Fax, **Entity** = Insured, **From/To** = From for a fax the agency
  received, To for one the agency sent. Follow `../references/web-logging.md`
