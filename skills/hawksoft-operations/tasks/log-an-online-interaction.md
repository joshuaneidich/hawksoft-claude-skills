...
Document an online / web portal interaction in the correct client record.

## Screen path

Use this exact action path:

Action → Online → From/To → Party → Log
...
- What the online interaction was
...
- **Yes, and this is a plain log** → log it there. In **New Log**, this task's path
  becomes **Channel** = Online, with **From/To** and **Entity** matching the direction
  and party of the interaction. Follow `../references/web-logging.md`
...
### 3. Choose Online, the direction, and the party
...
### 4. Enter the summary and any follow-up
