...
Document incoming or outgoing physical mail in the correct client record.

## Screen path

Use this exact action path:

Action → Mail → From/To → Party → Log
...
- **Yes, and this is a plain log** → log it there. In **New Log**, this task's path
  becomes **Channel** = Mail, with **From/To** and **Entity** matching the direction and
  party of the mail. Follow `../references/web-logging.md`
...
### 3. Choose Mail, the direction, and the party
