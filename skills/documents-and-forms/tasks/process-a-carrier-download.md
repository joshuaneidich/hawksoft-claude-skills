...
Review and file a carrier download into the correct client record.

## Screen path

Use this exact action path:

Action → Download → (carrier download)
...
### 4. Review and file it to the correct policy
