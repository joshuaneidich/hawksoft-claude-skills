...
Open a carrier website or inquiry for the correct client/policy.

## Screen path

Use this exact action path:

Action → Internal → Inquiry/Website
...
### 3. Choose the carrier / inquiry target
...
### 4. Complete the lookup and note the result
