...
Generate a document such as ID cards or a declarations page.

## Screen path

Use this exact action path:

Action → Internal → Print/Create
...
### 3. Choose Internal → Print/Create

In the Action menu, select **Internal**, then **Print/Create**. (Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)
