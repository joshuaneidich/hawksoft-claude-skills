...
Scan or import a document and attach it to the correct client record.

## Screen path

Use this exact action path:

Action → Internal → Scan
...
- How it should be titled/categorized
...
### 3. Choose Internal → Scan

In the Action menu, select **Internal**, then **Scan**. (Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 4. Scan or import the document
...
### 5. Title and categorize the attachment
