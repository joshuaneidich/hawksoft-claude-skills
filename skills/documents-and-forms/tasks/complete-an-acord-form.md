...
Fill out and generate an ACORD form for the client/policy.

## Screen path

Use this exact action path:

Action → Internal → ACORD Forms
...
### 3. Choose Internal → ACORD Forms

In the Action menu, select **Internal**, then **ACORD Forms**. (Fill in the exact click-through: which button/menu you select and what appears next. Replace this placeholder once verified against the real HawkSoft screen.)

### 4. Select the ACORD form
...
### 5. Confirm the prefilled data and complete remaining fields
